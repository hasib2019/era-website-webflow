...
@section('content')
@if(cms_section_visible('faq', 'faq_common_hero'))<header class="section-common-hero">
    ...
    @if(cms_section_visible('faq', 'faq_accordion'))<section class="section-faq">
        <div class="container-main">
    ...
    @if(cms_section_visible('faq', 'faq_cta'))<section class="section-cta">
        <div class="container-main">
            <div class="max-width-930px">
                <div class="cta-component">
                    ...
                    <div data-w-id="fb3d8211-581b-e555-5949-cd34f550b0e3" class="cta-image-wrap" style="opacity: 0;">
                        <img src="{{ cms_image('faq.faq_cta.cta_image', '/era/media/webflow/664c7b819abdb2098fe1c195_cta-image.jpg') }}"
