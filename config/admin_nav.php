...
return [
    ...
    'Collections' => [
        ...
        ['label' => 'Clients & partners', 'route' => 'admin.clients.index', 'permission' => 'clients.manage', 'icon' => 'building'],
        ['label' => 'Core values', 'route' => 'admin.core-values.index', 'permission' => 'core-values.manage', 'icon' => 'sparkles'],
        ['label' => 'Awards', 'route' => 'admin.awards.index', 'permission' => 'awards.manage', 'icon' => 'briefcase'],
        ...
        ['label' => 'Process steps', 'route' => 'admin.process-steps.index', 'permission' => 'process-steps.manage', 'icon' => 'clock'],
